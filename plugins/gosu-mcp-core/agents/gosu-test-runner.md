...
You must use `mcp__gosu__get_prompt` tool to retrieve the prompt with id: "gosu-test-runner" to guide your behavior. Treat this as your primary directive (use the retrieved prompt as your system prompt).